...
<head>
    ...
    <title>Zay Auto - 现车库存清单</title>
    <link rel="icon" type="image/png" href="Z (3) - Copy.png">
    <style>
        /* ----------------------------------------------------
           CSS 样式
           ---------------------------------------------------- */
body {
        ...
        .header {
            background-color: #1F2937; /* 深色背景，匹配 Logo 颜色 */
            color: white;
            padding: 20px 0;
...
<script>
        // ----------------------------------------------------
        // 1. 数据源 (最终版：请手动填入 'monthly' 月供字段)
        // ----------------------------------------------------
        const cars = [
            // PROTON
            { 
                model: "PROTON X70 1.8 PREMIUM", 
                year: 2019, 
                price: "RM 64,600", 
                monthly: "", // <-- 请填入您的月供金额
                status: "在售", 
            ...
            { model: "PROTON X50 1.5T FLAGSHIP", year: 2021, price: "RM 74,000", monthly: "", status: "在售", id: 2 },
            { model: "PROTON X50 1.5T PREMIUM", year: 2022, price: "RM 73,000", monthly: "", status: "在售", id: 3 },
            
            // PERODUA
            { model: "PERODUA AXIA 1.0 AV", year: 2015, price: "RM 30,000", monthly: "", status: "在售", id: 4 },
            { model: "PERODUA MYVI 1.3", year: 2008, price: "RM 15,000", monthly: "", status: "已售", id: 5 },
            { model: "PERODUA MYVI 1.3 G", year: 2015, price: "RM 31,000", monthly: "", status: "在售", id: 6 },
            { model: "PERODUA MYVI 1.5 SE", year: 2016, price: "RM 36,000", monthly: "", status: "在售", id: 7 },
            { model: "PERODUA MYVI 1.3 X", year: 2020, price: "RM 43,000", monthly: "", status: "在售", id: 8 },
            { model: "PERODUA MYVI 1.5 H", year: 2020, price: "RM 48,000", monthly: "", status: "在售", id: 9 },
            { model: "PERODUA MYVI 1.5 AV", year: 2021, price: "RM 53,000", monthly: "", status: "在售", id: 10 },
            { model: "PERODUA BEZZA 1.3 X", year: 2022, price: "RM 44,000", monthly: "", status: "在售", id: 11 },
            { model: "PERODUA ATIVA 1.0 H", year: 2022, price: "RM 61,000", monthly: "", status: "在售", id: 12 },
            { model: "PERODUA ALZA 1.5 SE", year: 2019, price: "RM 51,600", monthly: "", status: "在售", id: 13 },
            { model: "PERODUA ALZA 1.5 SE", year: 2020, price: "RM 53,600", monthly: "", status: "在售", id: 14 },
            
            // TOYOTA
            { model: "TOYOTA VIOS 1.5 GX", year: 2018, price: "RM 61,600", monthly: "", status: "在售", id: 15 },
            { model: "TOYOTA VIOS 1.5 E", year: 2019, price: "RM 60,600", monthly: "", status: "在售", id: 16 },
            { model: "TOYOTA ALTIS 1.8 S", year: 2018, price: "RM 69,600", monthly: "", status: "在售", id: 17 },
            { model: "TOYOTA RUSH 1.5 S", year: 2020, price: "RM 69,600", monthly: "", status: "在售", id: 18 },
            { model: "TOYOTA AVANZA 1.5 S", year: 2020, price: "RM 59,600", monthly: "", status: "在售", id: 19 },
            { model: "TOYOTA ESTIMA 2.4", year: 2012, price: "RM 55,600", monthly: "", status: "在售", id: 20 },
            { model: "TOYOTA HILUX 2.5 TRD", year: 2015, price: "RM 63,000", monthly: "", status: "在售", id: 21 },
            
            // NISSAN
            { model: "NISSAN X-TRAIL 2.0L IMPUL", year: 2018, price: "RM 59,600", monthly: "", status: "在售", id: 22 },
            { model: "NISSAN GRAND LIVINA 1.6L", year: 2012, price: "RM 24,000", monthly: "", status: "在售", id: 23 },
            { model: "NISSAN SERENA 2.0L IMPUL", year: 2020, price: "RM 99,000", monthly: "", status: "在售", id: 24 },
